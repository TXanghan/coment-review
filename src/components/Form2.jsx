      ...
      <tr>
        ...
        <td>Hobby</td>
            <td>
                ...
                <input type="Checkbox" name="hobby" value="read" onChange={handleInput}/>Read
                <input type="Checkbox" name="hobby" value="write" onChange={handleInput}/>Write
                <input type="Checkbox" name="hobby" value="yoga" onChange={handleInput}/>Yoga
            </td>
        </tr>
